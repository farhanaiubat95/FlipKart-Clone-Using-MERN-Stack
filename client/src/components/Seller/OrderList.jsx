...
const OrderList = () => {
    ...
    const products = useSelector((state) => state.Product.products); // get product list from redux
  ...
  try {
    ...
    const handlePrintRow = (order, serialNumber, totalQuantity) => {
        ...
        // Map order.items productId to productName by looking into products redux store
