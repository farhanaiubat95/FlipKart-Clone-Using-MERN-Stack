    ...
    return (
        <Box style={{ paddingLeft: '20px '}}>
            ...
            <Box>
                ...
                <Box component={"span"} style={{ fontSize: 28, fontWeight: 600 }}>Tk   {product.price.cost}</Box>
                <Box component={"span"} style={{ color: '#878787', margin: '0 15px', fontSize: 16 }}><strike>Tk  {product.price.mrp}</strike></Box>
                <Box component={"span"} style={{ color: '#388E3C', fontSize: 16 }}>{product.price.discount}</Box>
            </Box>
                        ...
                        <TableCell style={{ fontWeight: 600, verticalAlign: 'top' }}>
                            ...
                            <Box className="tableCell2" style={{ marginTop: 8 }}>
                                <ul style={{ marginLeft: -20 }}>
                                    ...
                                    <li><Typography style={{ fontSize: 13, marginTop: 5 }}>View more sellers starting from Tk  {product.price.cost}</Typography></li>
                                </ul>
                            </Box>
                        </TableCell>
                    </ColumnText>
